 ...
 */
class ListDetailsPresenter @Inject constructor(private val mView: ListDetailsContract.View,
	...
	override fun onAttach() {
		mDisposable.add(mListRepo.getShoppingListDetails(mListId).observeOn(
